...
const picture = person[x].picture.large;
const fName = person[x].name.first;
const lName = person[x].name.last;
const email = person[x].email;
const city = person[x].location.city;
const street = person[x].location.street;
