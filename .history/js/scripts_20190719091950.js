...
const picture = person[i].picture.large;
const fName = person[i].name.first;
const lName = person[i].name.last;
const email = person[i].email;
const city = person[i].location.city;
const street = person[i].location.street;
const state = person[i].location.state;
const postcode = person[i].location.postcode;
const phone = person[i].phone;
const dob = person[x].dob.date.slice(0, 10);
